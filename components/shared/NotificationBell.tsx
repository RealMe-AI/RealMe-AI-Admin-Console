...
import { Bell, ArrowUp, BarChart3, UserPlus, Bug, Cog, type LucideIcon } from "lucide-react"
        ...
        <div className="max-h-[calc(100vh-8rem)] space-y-0.5 overflow-y-auto p-2">
          {notifications.map((n) => {
            ...
            return (
              ...
              >
                <div className={cn("flex size-8 shrink-0 items-center justify-center rounded-lg", typeColors[n.type])}>
